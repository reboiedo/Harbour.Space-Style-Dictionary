...
var _1 = require(".");
// utils
var logObject = function (a) { return console.dir(a, { depth: 4 }); };
(0, vitest_1.describe)('calculateClamp', function () {
    (0, vitest_1.test)('should generate a single clamp function', function () {
        var result = (0, _1.calculateClamp)({ minSize: 16, maxSize: 32, minWidth: 320, maxWidth: 1240 });
        var expected = 'clamp(1rem, 0.6522rem + 1.7391vi, 2rem)';
        (0, vitest_1.expect)(result).toEqual(expected);
    });
    (0, vitest_1.test)('should generate a px clamp function', function () {
        var result = (0, _1.calculateClamp)({ minSize: 16, maxSize: 32, minWidth: 320, maxWidth: 1240, usePx: true });
        var expected = 'clamp(16px, 10.4348px + 1.7391vi, 32px)';
        (0, vitest_1.expect)(result).toEqual(expected);
    });
    (0, vitest_1.test)('should generate a cqi clamp function', function () {
        var result = (0, _1.calculateClamp)({ minSize: 16, maxSize: 32, minWidth: 320, maxWidth: 1240, relativeTo: 'container' });
        var expected = 'clamp(1rem, 0.6522rem + 1.7391cqi, 2rem)';
        (0, vitest_1.expect)(result).toEqual(expected);
    });
    (0, vitest_1.test)('should generate a vw clamp function', function () {
        var result = (0, _1.calculateClamp)({ minSize: 16, maxSize: 32, minWidth: 320, maxWidth: 1240, relativeTo: 'viewport-width' });
        var expected = 'clamp(1rem, 0.6522rem + 1.7391vw, 2rem)';
        (0, vitest_1.expect)(result).toEqual(expected);
    });
});
(0, vitest_1.describe)('calculateClamps', function () {
    (0, vitest_1.test)('should generate multiple clamps', function () {
        var result = (0, _1.calculateClamps)({ minWidth: 320, maxWidth: 1080, pairs: [[12, 16], [40, 28]] });
        var expected = [
            {
...
(0, vitest_1.describe)('calculateSpaceScale', function () {
    (0, vitest_1.test)('should generate a valid scale', function () {
        var result = (0, _1.calculateSpaceScale)({
            minWidth: 320,
            maxWidth: 1240,
            minSize: 18,
            maxSize: 20,
...
(0, vitest_1.describe)('calculateTypeScale', function () {
    (0, vitest_1.test)('should generate a valid scale', function () {
        var result = (0, _1.calculateTypeScale)({
            minWidth: 320,
            maxWidth: 1240,
            minFontSize: 18,
            maxFontSize: 20,
